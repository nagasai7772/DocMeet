      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex items-center gap-2 mt-1 text-gray-600'>
            ...
            <button className='py-0.5 px-2 bordertext-xs rounded-full'>{profileData.experience}</button>
          </div>
          {/* --About Doctor */}
          <div>
          ...
          {
            isEdit? <button onClick={updateProfile} className='px-4 py-1 border border-blue-800 text-sm rounded-full mt-5 hover:bg-blue-600 hover:text-white transition-all hover:scale-105  '>Save</button>
            :<button onClick={()=>setIsEdit(true)} className='px-4 py-1 border border-blue-800 text-sm rounded-full mt-5 hover:bg-blue-600 hover:text-white transition-all hover:scale-105  '>Edit</button>
          }

  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            <p className='text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight md:leading-tight lg:leading-none'>Book Appointment
        ...
        <div className='md:w-1/2 relative'>
            <img src={assets.doctors_img} alt="" className='w-full md:absolute bottom-0 h-auto rounded-lg'/>
        </div>
    </div>
  )
}
